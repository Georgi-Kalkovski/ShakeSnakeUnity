...
public class ScreenWrapBehaviour : MonoBehaviour
{
	...
	void Start()
	{
		...
		screenWidth = (screenTopRight.x - 1) - (screenBottomLeft.x + 1);
		screenHeight = (screenTopRight.y - 15) - (screenBottomLeft.y + 15);
		Debug.Log(String.Format("\n TopRightX: " + (screenTopRight.x - 1) + " BottomLeftX: " + (screenBottomLeft.x + 1) + " TopRightY: " + (screenTopRight.y - 5) + " BottomLeftY: " + (screenBottomLeft.y + 5)));
